...
Before using this tool, you need to obtain Twitter API credentials. Follow these steps:
...
4. Complete the application form:
   - **Use case**: Describe your project (e.g., "Academic research", "Market analysis")
   - **Country**: Select your country
   - **Coding experience**: Select your level
5. Agree to the Terms of Service
6. Submit your application

> **Note**: Approval can take from a few hours to several days. Twitter may ask for additional information.
...
3. Fill in the app details:
   ...
   - **Callback URL**: Not required for API access
4. Click "Create"
...
3. For **Bearer Token**: Click "Generate" if not already generated
4. **Important**: Copy and save these credentials immediately - you won't be able to see the secret keys again!

#### Step 4: Set API Access Level

1. In your app settings, go to "Settings" tab
2. Scroll down to "App permissions"
3. Select the appropriate access level:
   - **Read**: For scraping tweets and user data
   - **Read and Write**: For posting tweets and comments
   - **Read, Write, and Direct Messages**: For full automation
...
|---------------|------------|---------|
| Search Tweets | 300 requests | 15 minutes |
...
```env
# TwitterXAPI (Recommended - Current Implementation)
TWITTERX_BEARER_TOKEN=twitterx_your_actual_token_here

# Official Twitter API (Alternative)
